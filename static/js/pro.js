/* App JS — chips nav, ticker, cards, widgets */
...
function makeCard(item){
  ...
  const img=document.createElement('img'); img.loading='lazy'; img.src=item.image||item.thumbnail||''; img.alt=decodeEntities(item.title||'');
